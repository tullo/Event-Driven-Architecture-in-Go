...
Feature: Register Customer
  ...
  Scenario: Registering a new customer                # features/customers/register_customer.feature:3
    Given no customer named "John Smith" exists       # <autogenerated>:1 -> *customersContext
    When I register a new customer as "John Smith"    # <autogenerated>:1 -> *customersContext
    Then I expect the request to succeed              # <autogenerated>:1 -> *suiteContext
    And expect a customer named "John Smith" to exist # <autogenerated>:1 -> *customersContext
...
Feature: Create Store
  ...
  Scenario: Creating a store called "Waldorf Books" # features/stores/create_store.feature:6
    Given a valid store owner                       # <autogenerated>:1 -> *storesContext
    And no store called "Waldorf Books" exists      # <autogenerated>:1 -> *storesContext
    When I create the store called "Waldorf Books"  # <autogenerated>:1 -> *storesContext
    Then a store called "Waldorf Books" exists      # <autogenerated>:1 -> *storesContext

2 scenarios (2 passed)
8 steps (8 passed)
300.626726ms

Randomized with seed: 35839
--- PASS: TestEndToEnd (0.31s)
PASS
...
```log
monolith  | 12:14:11.982PM INF --> Customers.RegisterCustomer
monolith  | 12:14:11.983PM INF --> Customers.DomainEvents.On(customers.CustomerRegistered)
monolith  | 12:14:11.983PM INF <-- Customers.DomainEvents.On(customers.CustomerRegistered)
monolith  | 12:14:11.983PM INF <-- Customers.RegisterCustomer
monolith  | 12:14:12.123PM INF --> Stores.GetStores
monolith  | 12:14:12.123PM INF <-- Stores.GetStores
monolith  | 12:14:12.124PM INF --> Stores.CreateStore
monolith  | 12:14:12.126PM INF --> Stores.Mall.On(stores.StoreCreated)
monolith  | 12:14:12.126PM INF <-- Stores.Mall.On(stores.StoreCreated)
monolith  | 12:14:12.126PM INF --> Stores.DomainEvents.On(stores.StoreCreated)
monolith  | 12:14:12.127PM INF <-- Stores.DomainEvents.On(stores.StoreCreated)
monolith  | 12:14:12.127PM INF <-- Stores.CreateStore
monolith  | 12:14:12.425PM INF --> Depot.IntegrationEvents.On(storesapi.StoreCreated)
monolith  | 12:14:12.425PM INF <-- Depot.IntegrationEvents.On(storesapi.StoreCreated)
monolith  | 12:14:12.437PM INF --> Baskets.IntegrationEvents.On(storesapi.StoreCreated)
monolith  | 12:14:12.438PM INF <-- Baskets.IntegrationEvents.On(storesapi.StoreCreated)
monolith  | 12:14:12.438PM INF --> Payments.IntegrationEvents.On(storesapi.StoreCreated)
monolith  | 12:14:12.440PM INF <-- Payments.IntegrationEvents.On(storesapi.StoreCreated)
```
